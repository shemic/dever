...
func analyzeModelFile(moduleName, importRoot, relPath, fullPath string, importAliases map[string]string, aliasUsage map[string]int) ([]modelEntry, error) {
...
// Generated at: %s
// Description: 自动注册 model，扫描 module/*/model/*.go 及其重定向源，并将其接入 dever/load
